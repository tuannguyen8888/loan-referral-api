...
import {PtfAddress, PtfEmploymentInformation, PtfLoanProfile, PtfRelatedPerson, SendDataLog} from "../../../entities";
import {PtfLoanProfileRepository, SendDataLogRepository} from "../../../repositories";
                    ...
                    try {
                        body = {
                            ...
                            "enquiry": {
                                ...
                                "loanApplicationId": loanProfile.loanApplicationId,
                                "loanPublicId": loanProfile.loanPublicId,
                            }
                        };
