...
export class PtfMasterDataController {
  ...
  getMaritialStatus(
    ...
    return this.service.getMasterDatas(
      "MARITIAL_STATUS",
      null,
      null,
      dto.keyword
  ...
  getDistricts(
    ...
    return this.service.getMasterDatas(
      "DISTRICT",
      params.province_id ? params.province_id.toString() : null,
      null,
      dto.keyword
    );
  }
  ...
  getWards(
    ...
    return this.service.getMasterDatas(
      "WARD",
      params.district_id ? params.district_id.toString() : null,
      null,
      dto.keyword
    );
  }
