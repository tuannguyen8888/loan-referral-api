...
export class McScoringTrackingService extends BaseService{
    ...
    async getAllScoringTrackings(dto: GetMCScoringTrackingRequestDto) {
        try {
            const repo = this.connection.getCustomRepository(McScoringTrackingRepository);
    ...
    async createScoringTracking(dto: McScoringTrackingDto) {
        console.log(dto);
        let entity: McScoringTracking = this.convertDto2Entity(dto, McScoringTracking);
    ...
    async updateScoringTracking(dto: McScoringTrackingUpdateDto) {
        let entityUpdate: McScoringTracking = this.convertDto2Entity(dto, McScoringTracking);
