...
export class McKiosService extends BaseService {
  ...
  async getKios() {
    ...
    try {
      ...
      //     '        "id": 13127,' +
      //     '        "kioskCode": "KIK010001",' +
      //     '        "kioskAddress": "Số 203 Trần Hưng Đạo - Phường Mỹ Bình - Thành Phố Long Xuyên - An Giang",' +
      //     '        "kioskProvince": "AnGiang"' +
      //     '    },' +
      //     '    {' +
      //     '        "id": 13147,' +
      //     '        "kioskCode": "KIK030001",' +
      //     '        "kioskAddress": "Tầng 6, Tòa nhà Vietel, ngã tư Minh Khai, phường Hoàng Văn Thụ, T.p Bắc Giang, Tỉnh Bắc Giang",' +
