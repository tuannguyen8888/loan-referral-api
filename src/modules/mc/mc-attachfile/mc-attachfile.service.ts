...
export class McAttachfileService extends BaseService{
    ...
    async getAllAttachfile(dto: GetMCAttachfileRequestDto) {
        try {
            ...
            result.count = count;
            result.rows = this.convertEntities2Dtos(data, McAttachfile, McAttachfileResponseDto);
            return result;
        } catch (e) {
            console.error(e);
            throw e;
    ...
    async createAttachfile(dto: McAttachfileDto) {
        ...
        let response: McAttachfileDto = this.convertEntity2Dto(result, McAttachfile, McAttachfileDto);
        return response;
    }
