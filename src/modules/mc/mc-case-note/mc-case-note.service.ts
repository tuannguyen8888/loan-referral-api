...
import {McCasesResponseDto} from "../mc-case/dto/mc-cases.response.dto";
import {McCase, McCaseNote} from "../../../entities";
import {McCaseResponseDto} from "../mc-case/dto/mc-case.response.dto";
import {McCaseDto} from "../mc-case/dto/mc-case.dto";
import {McCaseUpdateDto} from "../mc-case/dto/mc-case.update.dto";
...
export class McCaseNoteService extends BaseService {
    ...
    async createCaseNote(dto: McCaseNoteDto) {
        console.log(dto);
        let entity: McCase = this.convertDto2Entity(dto, McCaseNote);
