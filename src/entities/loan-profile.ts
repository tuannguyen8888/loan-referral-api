...
export class LoanProfile {
  ...
  @Column("varchar", {
    ...
    nullable: true,
    comment:
      "Priority trên Finnone : Bank StatementBusiness LicenseNo Business LicenseNonePay Slip",
    length: 50
  })
  ...
  @Column("varchar", {
    name: "in_title",
    comment: "Title trên FinnoneMR.MRS.MS.  ",
    length: 4
  })
  inTitle: string;
  ...
  @Column("varchar", {
    name: "in_addresstype",
    nullable: true,
    comment: "•   HEADOFF - HEAD OFFICEBCHOFF - BRANCH OFFICE  ",
    length: 20
  })
